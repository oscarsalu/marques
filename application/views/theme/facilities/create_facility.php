...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
    <form class="form-horizontal" method="post" action="<?= site_url('facilities/add') ?>">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" class="form-control" name="id" placeholder="Enter  a valid facility id e.g AOiti3U3uFi "><span><?= form_error('id'); ?></span>
                  </div>
               </div>
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" class="form-control" name="code" placeholder="Enter mfl code for the facility e.g 17926"><span><?= form_error('code'); ?></span>
                  </div>
               </div>
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" name="shortname" placeholder="Enter facility shortname name e.g Homa Bay Community Medical Clinic">
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="fname" placeholder="Enter a facility name e.g Homa Bay Community Medical Clinic">
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="subcounty" placeholder="Enter a valid sub county name">
                  </div>
               </div>
                  <div class="form-group">
         ...
         <?php echo form_submit('submit', 'Create facility','class="btn btn-xs btn-success pull-right"');?>
        </div>
