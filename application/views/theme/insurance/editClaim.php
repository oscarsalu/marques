...
<div id="infoMessage"><?php echo $message;?></div>
        <?php echo form_open_multipart("insurance/editClaim");?>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     ...
                     <?php foreach ($fleet_type as $fleet) :?>
                       <option value="<?= $fleet->FleetType?>" <?php if ($claim_e->Fleet ===  $fleet->FleetType ): ?>
                       <?php echo "Selected" ?>
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="type">
                     ...
                     <?php foreach ($vehicle_type as $vehicle) :?>
                       <option value="<?= $vehicle->VehicleType?>" <?php if ($claim_e->Type ===  $vehicle->VehicleType ): ?>
                       <?php echo "Selected" ?>
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="vehicleNo">
                     ...
                     <?php foreach ($vehicle_No as $vehicle) :?>
                       <option value="<?= $vehicle->RegNo?>" <?php if ($claim_e->VehicleNo ===  $vehicle->RegNo ): ?>
                       <?php echo "Selected" ?>
      ...
      <?php echo form_hidden('id', $claim_e->Id);?>
      </div>
