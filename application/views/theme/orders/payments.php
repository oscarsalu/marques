...
<!-- Main content -->
    <section class="content">
      ...
      <div class="box box-success">
        ...
        <div class="box-body">
           ...
           <table class="table table-bordered">
             ...
             <tr>
                <td>Note:</td>
                <td><textarea class="form-control" name="note" id="note"  cols="20" title="note" ><?php if(!empty($obj['driver'])){ echo $obj['driver']; } ?></textarea><span><?= form_error('note'); ?></span></td>
             </tr>
           </table>
           <hr>
           <table class="table table-bordered">
     ...
     <input type="submit" class="btn  btn-success pull-right" name="submit" value="Save Invoice">
        </div>
